            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text(contacts[index].name ?? "", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                    Text(contacts[index].email ?? "", style: TextStyle(fontSize: 14)),
                    Text(contacts[index].phone ?? "", style: TextStyle(fontSize: 14)),
                  ],
                ),
              )
            ],
